...
# SECRET_KEY = 'django-insecure-gn@+6@04b#nwhmu%i_&08jj^&r8o0j*(9c%$ck0d16+l&j%32$'
...
CORS_ALLOWED_ORIGINS = [
    "http://localhost:4200",  # Reemplaza con el dominio de tu aplicación Angular en desarrollo
